  ...
  return (
    <div className={`flex items-center justify-center ${containerHeight}`}>
      <div
        ...
        style={{
          color: 'hsl(60 100% 60%)', // Moderately bright fallback color
          background: 'linear-gradient(180deg, hsl(60 100% 60%) 0%, hsl(120 50% 40%) 70%)',
          WebkitBackgroundClip: 'text',
          WebkitTextFillColor: 'transparent',
          backgroundClip: 'text',
          textShadow: `
            1px 1px 0px hsl(120 50% 30%),
            2px 2px 0px hsl(120 50% 25%),
            3px 3px 0px hsl(120 50% 20%),
            4px 4px 0px hsl(120 50% 15%),
            5px 5px 12px hsl(0 0% 0% / 0.8),
            0 0 25px hsl(60 100% 50% / 0.6)
          `,
          transform: 'perspective(1000px) rotateY(0deg)',
          filter: 'drop-shadow(0 0 15px hsl(60 100% 50% / 0.4))',
        }}
      >
        PRIMAL
      </div>
